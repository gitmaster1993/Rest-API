...
public class OPExternalSubmitAPITest {

	Logger logger = Logger.getLogger("OPExternalSubmitAPITest");
	...
	public void testExternalSubmitAPI() throws IOException, InvalidFormatException {
		...
		String filePath = "src/test/resources/OPExternalSubmit.xlsx";
		...
		try {
			urlString = new URL(testBase.getPstValidationHost() + "/office");
		...
		int statusCellNum = 11;
		int passFailCellNum = 12;
		FileOutputStream out = new FileOutputStream(
				new File("test-output/api-test-output/OPExternalSubmitResult.xlsx"));
		...
		logger.log(Level.INFO,
				() -> "Office External Submit API - Success count :" + pass + ", Failure count :" + fail);
		wb.write(out);
		out.close();
	}
